                      ...
                      >
                        ...
                        <AccordionContent className="px-6 pb-6 pt-4 border-t border-border/50">
                          <DirectorySettings
                            ...
                            claudeWslDir={settings?.claudeWslConfigDir}
                            codexDir={settings?.codexConfigDir}
                            codexWslDir={settings?.codexWslConfigDir}
                            geminiDir={settings?.geminiConfigDir}
                            geminiWslDir={settings?.geminiWslConfigDir}
                            opencodeDir={settings?.opencodeConfigDir}
                            opencodeWslDir={settings?.opencodeWslConfigDir}
                            openclawDir={settings?.openclawConfigDir}
                            openclawWslDir={settings?.openclawWslConfigDir}
